export const registryConfig = {
   ...
   * @example "@Athaxv" - Users can install components with: `npx shadcn add @Athaxv/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.REGISTRY_NAMESPACE || "@Athaxv",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://safeedaadmi.dev/r/{name}.json" resolves to "https://safeedaadmi.dev/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://safeedaadmi.dev/r/{name}.json",
};
