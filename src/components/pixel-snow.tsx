...
type SnowflakeVariant = "square" | "round" | "snowflake";
...
export function PixelSnow({
    ...
    const materialRef = useRef<ShaderMaterialType | null>(null);
    ...
    useEffect(() => {
        ...
        try {
            ...
            if (!renderer.getContext()) {
                console.warn("WebGL context not available, skipping snowfall animation");
                return;
            }
            ...
            // Silently handle WebGL errors to prevent React error boundary issues
            console.warn("Failed to initialize snowfall animation:", error);
            return;
        }
