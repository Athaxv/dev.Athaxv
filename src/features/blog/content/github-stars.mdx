...
image: https://assets.safeedaadmi.dev/images/blog/github-stars.webp
category: components
icon: github-stars
...
<ComponentPreview
  ...
  openInV0Url="https://safeedaadmi.dev/r/github-stars.json"
/>
...
```tsx
<GithubStars repo="ncdai/safeedaadmi.dev" stargazersCount={1050} />
```
