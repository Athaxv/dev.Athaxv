  ...
  return (
    ...
    >
      <div className="relative size-12 shrink-0">
        {typeof icon === "string" ? (
          <Image
            className="rounded-xl select-none corner-squircle supports-corner-shape:rounded-[50%] object-contain"
            src={icon}
            alt={title}
            width={48}
            height={48}
          ...
          <div className="flex size-full items-center justify-center rounded-xl bg-muted text-muted-foreground corner-squircle supports-corner-shape:rounded-[50%]">
            {/* @ts-ignore */}
      ...
      <div className="flex-1">
        <h3 className="flex items-center font-sans font-medium underline-offset-4 group-hover/link:underline">
          {title}
        </h3>
